...
mod tests {
    ...
    fn state_change_to_shard_chunk(
        ...
        chunk.header.as_mut().unwrap().shard_root = change.new_state_root.clone(); // Clone as shard_root needs ownership.
        ...
        chunk.transactions[0]
            .user_messages
            .extend(change.transactions[0].user_messages.iter().cloned()); // Clone user messages.
